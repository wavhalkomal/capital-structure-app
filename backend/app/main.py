        ...
        if res is not None:
            ...
            raise HTTPException(
                ...
                detail=(
                    ...
                    "Please enter Market Cap ($mm) manually, or try again later. If you're the app owner, set the environment variable FMP_API_KEY on the server for reliable market-cap lookups."
                ),
            )
